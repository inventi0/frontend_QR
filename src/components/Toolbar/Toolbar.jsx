...
const colors = [
  ...
  '#00B2FF', '#231FD3', '#A300BA', '#FF00FF', '#000000', '#5a2d00' // Example basic + custom
];
  ...
  return (
    <div className={styles.toolbar}>
      ...
      <div className={styles.toolSection}>
        <span className={styles.sectionTitle}>Инструменты</span>
        <button
          title="Ручка"
      ...
      {/* Line Width Section */}
      <div className={styles.toolSection}>
         <span className={styles.sectionTitle}>Размер</span>
         <input
            type="range"
      ...
      <div className={styles.toolSection}>
         <span className={styles.sectionTitle}>Цвет</span>
         <input
            type="color"
            title="Свой цвет"
            value={selectedColor}
       ...
       <div className={`${styles.toolSection} ${styles.actionsSection}`}>
         ...
         <button title="Очистить" className={styles.actionButton} onClick={clearCanvas}>
            <FaTrashAlt /> <span className={styles.buttonText}>Очистить</span>
         </button>
         <button title="Скачать изображение" className={styles.actionButton} onClick={downloadImage}>
